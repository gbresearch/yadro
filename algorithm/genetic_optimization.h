...
namespace gb::yadro::algorithm::conv {
    ...
    public:
        ...
        auto serialize(this auto&& self, auto&& archive)
        {
            ...
            std::invoke(std::forward<decltype(archive)>(archive), self.config,
                ...
                archive::serialize_as<std::size_t>(self.fn_call_count_),
                archive::serialize_as<std::size_t>(self.total_eval_requests_));
    ...
    private:
        ...
        mutable util::movable_atomic<size_t> fn_call_count_{ 0 };
        mutable util::movable_atomic<size_t> total_eval_requests_{ 0 };

        // Tracks current population size for thread-safe reads in report().
        util::movable_atomic<size_t> current_pop_size_{ 0 };
        ...
        mutable util::mutexer<std::mutex> stats_mutex_;
        mutable util::mutexer<std::mutex> history_mutex_;
